...
namespace Lab3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            a1 += 30M;
            Console.WriteLine($"a1: {a1}");
            Angle a2 = new Angle(Angle.pi / 4M, Angle.AngleUnits.Radians);
            Console.WriteLine($"a2: {a2}");
            a2 *= 2M;
            Console.WriteLine($"a2: {a2}");
            Angle a3 = new Angle(100, Angle.AngleUnits.Gradians);
            Console.WriteLine($"a3: {a3}");
            a3 += a2;
            Console.WriteLine($"a3: {a3}");
            Angle a4 = new Angle(0.25M, Angle.AngleUnits.Turns);
            ...
            Angle a = new Angle(90, Angle.AngleUnits.Degrees);
            ...
            a.Units = Angle.AngleUnits.Turns;
            for (int i = 0; i < 10; ++i)
            {
                a -= .20m;
                Console.WriteLine(a);
